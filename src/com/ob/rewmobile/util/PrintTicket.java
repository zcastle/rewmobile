...
public class PrintTicket {
	...
	public PrintTicket(Context context, String modeloImpresora, String tipoComprobante, Destino destino, PedidoController pedido) {
	...
	private int EnviarPrecuenta(){
		...
		try {
			...
			printer.openPrinter(Print.DEVTYPE_TCP, Globals.IMPRESORA_P);
