...
public class AccesoActivity extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gridView.setAdapter(new BloqueAdapter(this, Data.LST_MOZOS,
				BloqueAdapter.ITEM_MOZO));
		gridView.setOnItemClickListener(this);
	}

	/*
	 * private void showMessage(String message){ AlertDialog.Builder builder =
	 * new AlertDialog.Builder(this); builder.setMessage(message)
	 * .setTitle("Message"); AlertDialog dialog = builder.create();
	 * dialog.show(); }
	 */
	...
	public void onItemClick(AdapterView<?> parent, View arg1, int position,
		...
		// Toast.makeText(AccesoActivity.this, mozo.getName(),
