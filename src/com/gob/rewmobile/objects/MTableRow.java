...
public class MTableRow extends LinearLayout {
	...
	public void setProducto(Producto producto) {
		...
		setLayoutParams(new MTableRow.LayoutParams(LayoutParams.MATCH_PARENT,
		...
		MTableRow.LayoutParams lp0 = new MTableRow.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 1.0f);
		MTableRow.LayoutParams lp1 = new MTableRow.LayoutParams(
		...
		px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 110,
		...
		px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 130,
				getResources().getDisplayMetrics());
